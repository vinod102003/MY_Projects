//locomotive for smooth scrollin
...
gsap.from(".nlink", {
  ...
  duration: 1,
  opacity: 0,
  ease: "power3.easeInOut", // Update the ease property
});
...
Shery.imageEffect("#imgntext img", {
  ...
  config: {
    ...
    uFrequencyZ: { value: 34.35, range: [0, 100] },
    geoVertex: { range: [1, 64], value: 13.98 },
...
Shery.imageEffect("#bimg", {
  ...
  config: {
    ...
    noEffectGooey: { value: true },
    onMouse: { value: 1 },
    noise_speed: { value: 2.6, range: [0, 10] },
